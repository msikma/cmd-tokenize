...
const { splitNestedQuotes, handleSeparators, downgradeNestedQuotes, removeWhitespace, mergeConsecutiveArguments, flattenNestedQuotes } = require('./quotes')
...
const splitIntoArguments = (str, options, format) => {
  ...
  parsed = mergeConsecutiveArguments(parsed)
