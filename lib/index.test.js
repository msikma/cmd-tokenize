...
describe(`cmd-tokenize package`, () => {
  describe(`splitCommand()`, () => {
    ...
    it(`throws when an unbalanced quote is found in the input`, () => {
      expect(() => splitCommand(`command "a"`)).not.toThrow()
      expect(() => splitCommand(`command "a"b"c"`)).not.toThrow()
      expect(() => splitCommand(`command "a\\"b\\"c"`)).not.toThrow()
      expect(() => splitCommand(`command ""`)).not.toThrow()
      expect(() => splitCommand(`command "`)).toThrow()
      expect(() => splitCommand(`command "asdf xcv dfs`)).toThrow()
      expect(() => splitCommand(`command "zxcv\\" something`)).toThrow()
      expect(() => splitCommand(`command \\"zxcv" something`)).toThrow()
