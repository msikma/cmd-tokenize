...
describe(`cmd-tokenize package`, () => {
  describe(`splitCommand()`, () => {
    ...
    it(`throws on input that isn't a string`, () => {
      expect(() => splitCommand(1)).toThrow(ParseError)
      expect(() => splitCommand(null)).toThrow(ParseError)
      expect(() => splitCommand(['a', 'b'])).toThrow(ParseError)
      expect(() => splitCommand(-1)).toThrow(ParseError)
      expect(() => splitCommand([])).toThrow(ParseError)
      expect(() => splitCommand({})).toThrow(ParseError)
      expect(() => splitCommand(Symbol('a'))).toThrow(ParseError)
      expect(() => splitCommand('command')).not.toThrow(ParseError)
    })
  ...
  describe(`parseCommand()`, () => {
    ...
    it(`throws when anything other than a string is passed as argument`, () => {
      ...
      expect(() => parseCommand(['a', 'b'])).toThrow(ParseError)
      expect(() => parseCommand(-1)).toThrow(ParseError)
